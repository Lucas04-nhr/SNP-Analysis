...
# 读取CSV文件
data = pandas.read_csv('E:/Project/data/export/FMGC.sp/guangzhou_1.csv')
...
data_phenotype = pandas.read_csv('E:/Project/data/export/abundance_gz.csv')
...
phenotype.to_csv('E:/Project/data/plink/Guangzhou/gz_phenotype.tsv', sep='\t', index=False)
...
covariant.to_csv('E:/Project/data/plink/Guangzhou/gz_covariate.tsv', sep='\t', index=False)
